...
export default function NoticePage() {
  ...
  return (
    <Section className="pb-10 sm:pb-20" variant="secondary">
      <div className="max-w-5xl mx-auto">
        {/* 헤더 */}
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-xl sm:text-3xl font-bold text-white">공지사항</h1>
        ...
        <form onSubmit={handleSearch} className="mb-8">
          <div className="relative flex gap-2">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-indigo-500 text-white shadow-lg shadow-indigo-500/30 rounded-lg "
            >
              검색
            </button>
          </div>
